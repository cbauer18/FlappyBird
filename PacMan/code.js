...
var pipes = [ [250, 200, 50, 150],[350, 150, 50, 100],[480, 100, 50, 50] ]; // [x, y, w, h] of the passage
var pipe_dx = -2;
var birdY = 100;
var g = 0.1;
...
function drawBackground () {
    ...
    painter.fillRect(20,50,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(30,45,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(10,40,40,30);
    //cloud 2
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(120,60,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(130,55,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(110,50,40,30);
    //cloud 3
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(220,50,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(230,45,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(210,40,40,30);
    //cloud 4
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(320,60,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(330,55,40,30);
    painter.fillStyle = "#FFFFFF";
    painter.fillRect(310,50,40,30);
}
function drawPipes () {
